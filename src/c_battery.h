...
SCA_TDF_MODULE(c_battery){
	...
	SCA_CTOR(c_battery):out1("out1"),out2("out2"),count(0),out3("out3"),current_time(0), power(0.0),batt_mo(0.0), batt_depr(0.0), counter(0) {}
	...
	private:
	double battery_mo, battery_cap, current_time, lifetime, power, batt_mo, batt_depr;
